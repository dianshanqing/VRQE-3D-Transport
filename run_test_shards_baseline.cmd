...
set OUTROOT=outputs\test_s%STEPS%_baseline_total%TOTAL_SHOTS%_seed%SEED0%_chunk%SHOT_CHUNK%_%MPS_MAX_BOND%_%MPS_TRUNC%
...
set EXTRA=--kernel-profile baseline --test-measure-x --test-measure-coins --test-measure-dir --aer-safe-basis --aer-threads %AER_THREADS% --mps-max-bond %MPS_MAX_BOND% --mps-trunc %MPS_TRUNC% --aer-shot-chunk %SHOT_CHUNK% --aer-heartbeat-sec 300

echo ==========================================================
echo [RUN] s103 TEST shards (baseline)
